        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 xl:gap-14">
              ...
              {["Home", "Pujas", "Chatdhara", "Astrology", "Kundli"].map(
                (item, idx) => (
                  <li key={idx}>
                    <a
                      href="#"
                      className="text-sm sm:text-base text-gray-600 hover:text-orange-500 transition-colors duration-200 inline-block"
                    >
                      {item}
                    </a>
                  </li>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-blue-600 flex items-center justify-center hover:bg-blue-700 transition-all hover:scale-110"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-pink-600 flex items-center justify-center hover:bg-pink-700 transition-all hover:scale-110"
              ...
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-red-600 flex items-center justify-center hover:bg-red-700 transition-all hover:scale-110"
                aria-label="YouTube"
              >
              ...
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-green-600 flex items-center justify-center hover:bg-green-700 transition-all hover:scale-110"
                aria-label="WhatsApp"
              >
